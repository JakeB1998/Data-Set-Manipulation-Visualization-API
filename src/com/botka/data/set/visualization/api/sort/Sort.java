...
/**
 * Base class that represent all sorting algorithms.
 * Meant to be extending by a specific sorting implementation.
 * Derives from base class StepOperation to be utilized by the render engine class.
 *
 * @author Jake Botka
 *
 */
