...
/**
 * A class implementation of a Bubble sort that can be played out slowly by the
 * RenderEngine class. providing implementation from the abstract class: Sort.>
 *
 * @author Jake Botka
 *
 */
public class BubbleSort extends Sort {
	...
	public BubbleSort(DataSet<?> set) {
		...
		super.registerOnFinishedListener(null);
