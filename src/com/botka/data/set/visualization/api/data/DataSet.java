...
import com.botka.data.set.visualization.api.util.Loggable;
...
public class DataSet<T extends Comparable> extends ArrayList<T> implements Loggable {
	...
	/**
	 * Constructor that accepts an array of data to be comppied into the dynamic
	 * arraylist
	 * 
	...
	/**
	 * This method determines wether or not an object is an instance of the Number
	 * class defining wether this object has numerical value that can be read.
	 * 
	 * @param element
	...
	/**
	 * Gets value of an object utilizing the comperable interface method by
	 * comparing the parameter by 0 revealing its value
	 * 
	 * @param value
	 * @return
	 */
	...
	/**
	 * Swaps two elements. Hannldes with size and index shifts due to the remove
	 * method
	 * 
	...
	public void swap(int index1, int index2) {
		int shift = 0;
		if (index1 < index2)
			shift = 1; // due to remove method if removed element is a lower index then all indexes
	...
	/**
	 * logs the current state of the dataset into its history. This is a
	 * synchronized method and is thread safe.
	 */
	...
	/**
	 * Increments position. This is synchronized and will block if multiple threads
	 * attempt to access resource method.
	 */
	...
	/**
	 * 
	 * This is synchronized and will block if multiple threads attempt to access
	 * resource method.
	 */
