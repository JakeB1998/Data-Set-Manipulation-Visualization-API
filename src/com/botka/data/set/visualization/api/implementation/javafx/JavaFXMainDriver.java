 ...
 */
package com.botka.data.set.visualization.api.implementation.javafx;
...
public class JavaFXMainDriver extends Application implements IRunOnMainThread, IFinishedListener
{
	...
	public void start(Stage stage) throws Exception
	{
		try
		{
			...
			stepOp = new BubbleSort(mDataset, this); // this being the IFInishedListener Implementation
			 stepOp =new SelectionSort (mDataset, this); // this being the IFInishedListener Implementation
	...
	public static DataSet randomizedData()
	{
